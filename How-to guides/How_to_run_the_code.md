...
### 3) Check the location of the function libraries
Be sure that the libraries with the definition of the three functions "AMS_functions.py", "Make_model.py" and "Plot_distributions.py" are in the same folder of the "Program.ipynb".
